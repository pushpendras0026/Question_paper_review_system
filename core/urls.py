...
urlpatterns = [
    ...
    path('app-admin/assign-advisor/', views.admin_assign_advisor, name='admin_assign_advisor'),
    ...
    path('app-admin/force-enroll/', views.admin_force_enroll, name='admin_force_enroll'),
    ...
    path('ta/course/<int:assignment_id>/assign-grades/', views.ta_assign_grades, name='ta_assign_grades'),
]
